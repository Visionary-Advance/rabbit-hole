      ...
      >
        ...
        <div className="p-4">
          ...
          {otherModifierGroups?.length > 0 && (
            <details className="group mb-6 w-full max-w-md rounded-xl border border-gray-200 bg-white shadow-md p-4 transition-all duration-300">
              <summary className="font-semibold cursor-pointer text-lg text-gray-800 select-none list-none flex items-center justify-between [&::-webkit-details-marker]:hidden">
                Customize
                <svg className="w-5 h-5 text-gray-500 transition-transform duration-300 group-open:rotate-180" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
