...
export default function Contact(){
    ...
    return(
      ...
      <section id="contact" className="py-5 md:py-5 lg:py-5 px-6 md:px-16 lg:px-32 xl:px-36 bg-black">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8 mb-12 lg:mb-16">
            ...
            <div className="flex flex-col gap-6 p-6 rounded-3xl bg-secondary">
              <div className="flex items-center gap-6">
                <div className="w-14 h-14 rounded-full bg-[#FFFAF4] flex items-center justify-center">
