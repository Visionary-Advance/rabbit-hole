        ...
        {/* Navigation */}
                <nav className="relative z-20 flex justify-between items-center px-6 md:px-16 lg:px-32 xl:px-36 py-5 bg-white">
                  <div className="flex items-center gap-6">
                    <div className="flex items-center gap-6">
                      ...
                      <div className="hidden md:flex items-center gap-8">
                        ...
                        <a href="#menu" className="text-black-900">{t('nav.menu')}</a>
                        <a href="#about" className="text-black-900">{t('nav.about')}</a>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <span className="text-black-900 font-medium text-sm">{t('nav.cart')}</span>
