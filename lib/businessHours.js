...
export function isShopOpen() {
  ...
  const businessHours = {
    0: { open: 8, close: 20 },   // Sunday: 8 AM - 6 PM PT
    ...
    6: { open: 8, close: 20 },   // Saturday: 8 AM - 9 PM PT
  };
...
export function getShopStatus() {
  ...
  const businessHours = {
    0: { open: 11, close: 20, label: 'Sunday' },      // Sunday: 8 AM - 6 PM PT
    1: { open: 11, close: 20, label: 'Monday' },      // Monday - Friday: 7 AM - 8 PM PT
    2: { open: 11, close: 20, label: 'Tuesday' },
    3: { open: 11, close: 20, label: 'Wednesday' },
    4: { open: 11, close: 20, label: 'Thursday' },
    5: { open: 11, close: 20, label: 'Friday' },
    6: { open: 11, close: 20, label: 'Saturday' },    // Saturday: 8 AM - 9 PM PT
  };
